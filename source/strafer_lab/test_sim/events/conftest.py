...
"""Shared pytest fixtures for event / domain randomization tests.
...
def _get_or_create_env():
    """Get or create the shared event-test environment."""
    global _module_env
...
def event_env():
    """Provide Strafer environment for event testing."""
