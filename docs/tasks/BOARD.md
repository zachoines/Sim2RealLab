...
|---|---|---|---|
| [`hybrid-replan-ownership`](active/trained-policy/hybrid-replan-ownership.md) | Jetson | PR pending | unit + colcon + fake-planner live smoke green; merge gated on the operator hybrid sim mission |
...
| [`hybrid-replan-ownership`](active/trained-policy/hybrid-replan-ownership.md) | P2 | in flight | Jetson |
