...
| [`procroom-placement-architecture`](active/trained-policy/procroom-placement-architecture.md) | P2 | active — design shipped (#160), implementation split pending pickup (guard net → zero-code re-range arm → surgery) | DGX |
