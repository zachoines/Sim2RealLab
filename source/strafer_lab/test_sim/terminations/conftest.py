...
"""Shared pytest fixtures for termination function tests.
...
from test_sim.common import NUM_ENVS
...
def _get_or_create_env():
    """Get or create the shared termination-test environment."""
    global _module_env
...
def term_env():
    """Provide Strafer environment for termination testing."""
