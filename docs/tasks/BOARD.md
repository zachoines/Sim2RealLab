...
| [`procroom-depth-enrichment`](active/trained-policy/procroom-depth-enrichment.md) | P2 | active — impl PR (Phase-0 instrument + Tier-1 + F1 enclosure; new enriched depth variant IDs); calibration + retrain open | DGX |
