...
| [`hybrid-mode`](completed/hybrid-mode.md) | P3 | shipped 2026-06-28 (#119 A, #122 B, #<PRC> C; Jetson) — generator + /plan subscription, variant-agnostic obs assembly, hybrid dispatch + two-node plan-freshness guard | Jetson |
