...
NOTE: AppLauncher is initialized in test_sim/conftest.py (root).
...
from test_sim.common.robot import reset_robot_pose
import warp as wp
...
NUM_ENVS_INTEGRATION = COMMON_NUM_ENVS  # 64, from test_sim.common
...
def pytest_sessionfinish(session, exitstatus):
    ...
    if _module_env is not None:
        _module_env.close()
        _module_env = None
    # Note: simulation_app.close() is handled by root test_sim/conftest.py
