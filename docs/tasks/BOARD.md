...
| [`hybrid-mode`](active/trained-policy/hybrid-mode.md) | P3 | active (Jetson; ships across PRs A/B/C — PR A = generator + /plan subscription) | Jetson |
