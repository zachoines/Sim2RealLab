...
|---|---|---|---|
| [`inference-goal-watchdog-latched`](active/trained-policy/inference-goal-watchdog-latched.md) | Jetson | PR pending | fix in `e795719`; unit + colcon + live-node smoke green; merge gated on the operator sim missions |
