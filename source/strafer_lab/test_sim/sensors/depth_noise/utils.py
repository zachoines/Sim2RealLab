...
Shared statistical utilities are imported from test_sim.common.
"""
...
from test_sim.common.constants import (
    CONFIDENCE_LEVEL,
    NUM_ENVS,
    N_SETTLE_STEPS,
    N_SAMPLES_STEPS,
...
from test_sim.common.stats import (
    variance_ratio_test,
    binomial_test,
    one_sample_t_test,
    VarianceTestResult,
...
def get_geometric_wall_mask(env, device: str = "cuda:0") -> torch.Tensor:
    ...
    from test_sim.sensors.depth_noise.scene_cfg import (
...
from test_sim.common.robot import (
    get_env_origins,
    reset_robot_pose,
...
def create_depth_test_env(noise_cfg, num_envs: int = NUM_ENVS, use_test_scene: bool = False):
    ...
    if use_test_scene:
        from test_sim.sensors.depth_noise.scene_cfg import DepthNoiseTestSceneCfg, ENV_SPACING
