...
2. [`hybrid-mode`](hybrid-mode.md) (Jetson, parked P3 — itself
   blocked on `subgoal-env`) — supplies the
...
[`hybrid-mode`](hybrid-mode.md)'s implementer (whoever picks it up)
...
- [hybrid-mode.md](hybrid-mode.md) — the consumer-side runtime brief.
...
- [`hybrid-mode.md`](hybrid-mode.md) — the consumer brief. Its
