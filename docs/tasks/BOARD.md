...
| [`occupancy-interior-fidelity`](completed/harness/occupancy-interior-fidelity.md) | P1 | shipped 2026-06-27 ([#114](https://github.com/zachoines/Sim2RealLab/pull/114), `65532d3`) — root-caused seed2+seed6 whole-footprint over-occupancy to a `skirtingboard_support` `convexHull` collider (phantom floor slab); `refit_trim_collider_approximations` corrects it before the cook (persisted). seed2 23→72 %, seed6 21→72 % free/floor-bbox; healthy 3 unchanged. 5/5 corpus now capturable. | DGX |
