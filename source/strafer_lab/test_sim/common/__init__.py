...
This module provides shared utilities across all test suites:
...
Usage:
    from test_sim.common import CONFIDENCE_LEVEL, chi_squared_variance_test
    from test_sim.common.circular import circular_mean, circular_ci
