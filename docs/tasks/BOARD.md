...
| [`coverage-spawn-from-occupancy`](active/harness/coverage-spawn-from-occupancy.md) | P1 | active — derive the coverage capture spawn from in-driver occupancy free-space; drops the `scenes_metadata.json` dependency (#112 comment 3) + unblocks the seed2 occupancy/spawn frame mismatch (0 episodes today) | DGX |
