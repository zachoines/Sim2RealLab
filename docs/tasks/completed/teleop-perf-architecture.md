...
**Follow-ups:** [`roller-contact-high-omega-bounce`](roller-contact-high-omega-bounce.md) — residual chassis bounce at sustained near-max yaw rate; [`headless-training-video-black`](headless-training-video-black.md) — black `--headless --video` training clips, bisected to the env-cfg-composition epic.
