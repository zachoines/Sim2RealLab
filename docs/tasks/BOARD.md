...
| [`export-nocam-subgoal-variant`](completed/export-nocam-subgoal-variant.md) | DGX | [#118](https://github.com/zachoines/Sim2RealLab/pull/118) | DGX-lane code + tests + brief shipped; pure-Python gate green (661 passed, 1 skipped). Pending operator-run GPU/Kit export of the converged `NOCAM_SUBGOAL` `model_2999.pt` + sidecar `policy_variant` verification. Unblocks the parked Jetson-lane [`hybrid-mode`](parked/trained-policy/hybrid-mode.md) consumer. |
